...
// Contains reports whgclchain the given IP is contained in the list.
...
// IsLAN reports whgclchain an IP is a local network address.
...
// IsSpecialNetwork reports whgclchain an IP is located in a special-use network range
...
// CheckRelayIP reports whgclchain an IP relayed from the given sender IP
...
// SameNet reports whgclchain two IP addresses have an equal prefix of the given bit length.
...
// Contains whgclchain the given IP is contained in the set.
