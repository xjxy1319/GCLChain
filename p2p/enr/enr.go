...
// Package enr implements Gclchain Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whgclchain the record is signed using the given identity scheme.
