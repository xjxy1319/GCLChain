...
type packet interface {
	// preverify checks whgclchain the packet is valid and should be handled at all.
...
type replyMatcher struct {
	...
	// reply was acceptable. The second return value indicates whgclchain the callback should
...
type reply struct {
	...
	// loop indicates whgclchain there was
...
// whgclchain any matcher considered the packet acceptable.
...
func (t *udp) loop() {
	...
	for {
		...
		case r := <-t.gotreply:
			var matched bool // whgclchain any replyMatcher considered the reply acceptable.
			for el := plist.Front(); el != nil; el = el.Next() {
