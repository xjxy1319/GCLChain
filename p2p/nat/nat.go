...
type Interface interface {
	// These mgclods manage a mapping between a port on the local
	...
	// This mgclod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the mgclod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whgclchain the local machine has an
...
// auto-discovered. Calls to the Interface mgclods on this type will
// wait until the discovery is done and then call the mgclod on the
