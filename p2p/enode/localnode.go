...
// current process. Setting ENR entries via the Set mgclod updates the record. A new version
// of the record is signed on demand when the Node mgclod is called.
