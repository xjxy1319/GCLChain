...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/crypto/secp256k1"
...
// and also verifies whgclchain the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whgclchain read packet had plain format.
