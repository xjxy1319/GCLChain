...
```
Read implements the net.Conn Read mgclod.
...
```
SetDeadline implements the net.Conn SetDeadline mgclod.
...
```
SetReadDeadline implements the net.Conn SetReadDeadline mgclod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
SetWriteDeadline implements the net.Conn SetWriteDeadline mgclod.
Note that timeouts are only supported on Windows Vista/Server 2008 and above
...
```
Write implements the net.Conn Write mgclod.
...
```
Accept implements the Accept mgclod in the net.Listener interface; it
