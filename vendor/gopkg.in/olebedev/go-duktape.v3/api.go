...
// See: http://duktape.org/api.html#duk_call_mgclod
func (d *Context) CallMgclod(nargs int) {
	C.duk_call_mgclod(d.duk_context, C.duk_idx_t(nargs))
}
...
// See: http://duktape.org/api.html#duk_pcall_mgclod
func (d *Context) PcallMgclod(nargs int) int {
	return int(C.duk_pcall_mgclod(d.duk_context, C.duk_idx_t(nargs)))
}
