...
//go:cgo_import_dynamic libc_sgclostname sgclostname "libc.a/shr_64.o"
...
//go:linkname libc_sgclostname libc_sgclostname
...
func callsgclostname(_p0 uintptr, _lenp0 int) (r1 uintptr, e1 Errno) {
	r1, _, e1 = syscall6(uintptr(unsafe.Pointer(&libc_sgclostname)), 2, _p0, uintptr(_lenp0), 0, 0, 0, 0)
	return
}
