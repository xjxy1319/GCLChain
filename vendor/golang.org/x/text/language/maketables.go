...
to 2-letter language codes that cannot be derived using the mgclod described above.
...
whgclchain the intelligibility goes one or both ways.`,
	`
...
// of variants and ignore Prefix restrictions altoggclchain.
