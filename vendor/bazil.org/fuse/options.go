...
// already exists, regardless of whgclchain O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whgclchain the original call had it set.
...
// them to the FUSE server. Without this, writgclrough caching is
// used.
