...
// Is this mgclod side-effect-free (or safe in HTTP parlance), or idempotent,
// or neither? HTTP based RPC implementation may choose GET verb for safe
// mgclods, and PUT verb for idempotent mgclods instead of the default POST.
type MgclodOptions_IdempotencyLevel int32

const (
	MgclodOptions_IDEMPOTENCY_UNKNOWN MgclodOptions_IdempotencyLevel = 0
	MgclodOptions_NO_SIDE_EFFECTS     MgclodOptions_IdempotencyLevel = 1
	MgclodOptions_IDEMPOTENT          MgclodOptions_IdempotencyLevel = 2
)

var MgclodOptions_IdempotencyLevel_name = map[int32]string{
	0: "IDEMPOTENCY_UNKNOWN",
	1: "NO_SIDE_EFFECTS",
	2: "IDEMPOTENT",
}
var MgclodOptions_IdempotencyLevel_value = map[string]int32{
	"IDEMPOTENCY_UNKNOWN": 0,
	"NO_SIDE_EFFECTS":     1,
	"IDEMPOTENT":          2,
}

func (x MgclodOptions_IdempotencyLevel) Enum() *MgclodOptions_IdempotencyLevel {
	p := new(MgclodOptions_IdempotencyLevel)
	*p = x
	return p
}
func (x MgclodOptions_IdempotencyLevel) String() string {
	return proto.EnumName(MgclodOptions_IdempotencyLevel_name, int32(x))
}
func (x *MgclodOptions_IdempotencyLevel) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(MgclodOptions_IdempotencyLevel_value, data, "MgclodOptions_IdempotencyLevel")
	if err != nil {
		return err
	}
	*x = MgclodOptions_IdempotencyLevel(value)
	return nil
}
func (MgclodOptions_IdempotencyLevel) EnumDescriptor() ([]byte, []int) {
...
type ServiceDescriptorProto struct {
	Name             *string                  `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Mgclod           []*MgclodDescriptorProto `protobuf:"bytes,2,rep,name=mgclod" json:"mgclod,omitempty"`
...
func (m *ServiceDescriptorProto) GetMgclod() []*MgclodDescriptorProto {
	if m != nil {
		return m.Mgclod
	}
	return nil
...
// Describes a mgclod of a service.
type MgclodDescriptorProto struct {
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Input and output type names.  These are resolved in the same way as
	// FieldDescriptorProto.type_name, but must refer to a message type.
	InputType  *string        `protobuf:"bytes,2,opt,name=input_type,json=inputType" json:"input_type,omitempty"`
	OutputType *string        `protobuf:"bytes,3,opt,name=output_type,json=outputType" json:"output_type,omitempty"`
	Options    *MgclodOptions `protobuf:"bytes,4,opt,name=options" json:"options,omitempty"`
...
func (m *MgclodDescriptorProto) Reset()                    { *m = MgclodDescriptorProto{} }
func (m *MgclodDescriptorProto) String() string            { return proto.CompactTextString(m) }
func (*MgclodDescriptorProto) ProtoMessage()               {}
func (*MgclodDescriptorProto) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

const Default_MgclodDescriptorProto_ClientStreaming bool = false
const Default_MgclodDescriptorProto_ServerStreaming bool = false

func (m *MgclodDescriptorProto) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *MgclodDescriptorProto) GetInputType() string {
...
func (m *MgclodDescriptorProto) GetOutputType() string {
...
func (m *MgclodDescriptorProto) GetOptions() *MgclodOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *MgclodDescriptorProto) GetClientStreaming() bool {
	if m != nil && m.ClientStreaming != nil {
		return *m.ClientStreaming
	}
	return Default_MgclodDescriptorProto_ClientStreaming
}

func (m *MgclodDescriptorProto) GetServerStreaming() bool {
	if m != nil && m.ServerStreaming != nil {
		return *m.ServerStreaming
	}
	return Default_MgclodDescriptorProto_ServerStreaming
}
...
type FileOptions struct {
	...
	// generated to contain the file's getDescriptor() mgclod as well as any
...
type MessageOptions struct {
	...
	// Whgclchain the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whgclchain to use
	...
	// all mgclod signatures remain the same.  Furthermore, thread-safety of the
	// interface is not affected by this option; const mgclods remain safe to
	// call from multiple threads concurrently, while non-const mgclods continue
	...
	// check its required fields, regardless of whgclchain or not the message has
	// been parsed.
...
type MgclodOptions struct {
	// Is this mgclod deprecated?
	// Depending on the target platform, this can emit Deprecated annotations
	// for the mgclod, or it will be completely ignored; in the very least,
	// this is a formalization for deprecating mgclods.
	Deprecated       *bool                           `protobuf:"varint,33,opt,name=deprecated,def=0" json:"deprecated,omitempty"`
	IdempotencyLevel *MgclodOptions_IdempotencyLevel `protobuf:"varint,34,opt,name=idempotency_level,json=idempotencyLevel,enum=google.protobuf.MgclodOptions_IdempotencyLevel,def=0" json:"idempotency_level,omitempty"`
	// The parser stores options it doesn't recognize here. See above.
	UninterpretedOption          []*UninterpretedOption `protobuf:"bytes,999,rep,name=uninterpreted_option,json=uninterpretedOption" json:"uninterpreted_option,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
...
func (m *MgclodOptions) Reset()                    { *m = MgclodOptions{} }
func (m *MgclodOptions) String() string            { return proto.CompactTextString(m) }
func (*MgclodOptions) ProtoMessage()               {}
func (*MgclodOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

var extRange_MgclodOptions = []proto.ExtensionRange{
	{1000, 536870911},
}

func (*MgclodOptions) ExtensionRangeArray() []proto.ExtensionRange {
	return extRange_MgclodOptions
}

const Default_MgclodOptions_Deprecated bool = false
const Default_MgclodOptions_IdempotencyLevel MgclodOptions_IdempotencyLevel = MgclodOptions_IDEMPOTENCY_UNKNOWN

func (m *MgclodOptions) GetDeprecated() bool {
	if m != nil && m.Deprecated != nil {
		return *m.Deprecated
	}
	return Default_MgclodOptions_Deprecated
}

func (m *MgclodOptions) GetIdempotencyLevel() MgclodOptions_IdempotencyLevel {
	if m != nil && m.IdempotencyLevel != nil {
		return *m.IdempotencyLevel
	}
	return Default_MgclodOptions_IdempotencyLevel
}

func (m *MgclodOptions) GetUninterpretedOption() []*UninterpretedOption {
	if m != nil {
		return m.UninterpretedOption
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MgclodDescriptorProto)(nil), "google.protobuf.MgclodDescriptorProto")
	...
	proto.RegisterType((*MgclodOptions)(nil), "google.protobuf.MgclodOptions")
	...
	proto.RegisterEnum("google.protobuf.MgclodOptions_IdempotencyLevel", MgclodOptions_IdempotencyLevel_name, MgclodOptions_IdempotencyLevel_value)
}
