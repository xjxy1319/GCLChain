...
type Options struct {
	...
	// ErrorIfExist defines whgclchain an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whgclchain an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whgclchain block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whgclchain to sync underlying writes from the OS buffer cache
