...
// BasicArray is the interface that wraps basic Len and Search mgclod.
...
// Array is the interface that wraps BasicArray and basic Index mgclod.
...
// Array is the interface that wraps BasicArray and basic Get mgclod.
