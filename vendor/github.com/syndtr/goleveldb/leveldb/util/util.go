...
// Releaser is the interface that wraps the basic Release mgclod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser mgclod.
...
// Released returns whgclchain Release mgclod already called.
