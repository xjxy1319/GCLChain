...
// A Buffer is a variable-sized buffer of bytes with Read and Write mgclods.
...
// are no intervening mgclod calls on the Buffer.
...
// The slice is only valid until the next call to a read or write mgclod.
