...
// Syncer is the interface that wraps basic Sync mgclod.
...
// Locker is the interface that wraps Unlock mgclod.
...
type Storage interface {
	...
	// Caller should call Unlock mgclod after use.
	Lock() (Locker, error)
	...
	// mgclod. The 'file descriptor' should point to a valid file.
	...
	// can be updated using SetMeta mgclod.
	...
	// The file types may be OR'ed toggclchain.
