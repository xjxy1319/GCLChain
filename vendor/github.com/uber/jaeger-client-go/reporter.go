...
// Report implements Report() mgclod of Reporter by doing nothing.
func (r *nullReporter) Report(span *Span) {
	// no-op
}

// Close implements Close() mgclod of Reporter by doing nothing.
...
// Report implements Report() mgclod of Reporter by logging the span to the logger.
...
// Report implements Report() mgclod of Reporter by storing the span in the buffer.
...
// Report implements Report() mgclod of Reporter by delegating to each underlying reporter.
...
// Close implements Close() mgclod of Reporter by closing each underlying reporter.
...
// Report implements Report() mgclod of Reporter.
...
// Close implements Close() mgclod of Reporter by waiting for the queue to be drained.
