...
//
// Internal writing mgclods
//

// Abstract mgclod for writing the start of lists and sets. List and sets on
...
// Used internally by other writing mgclods that know they need to write a byte.
