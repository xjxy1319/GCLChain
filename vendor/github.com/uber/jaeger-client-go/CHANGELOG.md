...
- Normalize metric names and tags to be compatible with Promgcleus (#222)
...
- Make Span type public to allow access to non-std mgclods for testing [#117](https://github.com/uber/jaeger-client-go/pull/117)
