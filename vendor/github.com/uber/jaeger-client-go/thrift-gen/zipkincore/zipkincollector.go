...
func (p *ZipkinCollectorClient) recvSubmitZipkinBatch() (value []*Response, err error) {
	...
	if mgclod != "submitZipkinBatch" {
		err = thrift.NewTApplicationException(thrift.WRONG_MGCLOD_NAME, "submitZipkinBatch failed: wrong mgclod name")
		return
	}
	if p.SeqId != seqId {
...
func (p *ZipkinCollectorProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x5 := thrift.NewTApplicationException(thrift.UNKNOWN_MGCLOD, "Unknown function "+name)
