...
type Tracer struct {
	...
	options struct {
		poolSpans            bool
		gen128Bit            bool // whgclchain to generate 128bit trace IDs
...
// StartSpan implements StartSpan() mgclod of opentracing.Tracer.
...
func (t *Tracer) startSpanWithOptions(
	...
	// Predicate whgclchain the given span context is a valid reference
...
// Inject implements Inject() mgclod of opentracing.Tracer
...
// Extract implements Extract() mgclod of opentracing.Tracer
