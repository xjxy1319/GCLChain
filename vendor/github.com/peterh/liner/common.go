...
// SetCtrlCAborts sets whgclchain Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whgclchain line is auto-wrapped. The default is false (single line).
...
// whgclchain to retry the call to, or return the error returned by, readNext.
