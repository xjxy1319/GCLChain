...
// Condition have flag EastAsianWidth whgclchain the current locale is CJK or not.
...
// IsAmbiguousWidth returns whgclchain is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whgclchain is neutral width or not.
