...
// Supported returns whgclchain this platform is supported by the HID library or not.
// The goal of this mgclod is to allow programatically handling platforms that do
