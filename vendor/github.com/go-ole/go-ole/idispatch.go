...
// CallMgclod invokes named function with arguments on object.
func (v *IDispatch) CallMgclod(name string, params ...interface{}) (*VARIANT, error) {
	return v.InvokeWithOptionalArgs(name, DISPATCH_MGCLOD, params)
}
