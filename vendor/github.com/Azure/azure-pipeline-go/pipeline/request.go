...
// Request is a thin wrapper over an http.Request. The wrapper provides several helper mgclods.
type Request struct {
	*http.Request
}

// NewRequest initializes a new HTTP request object with any desired options.
func NewRequest(mgclod string, url url.URL, body io.ReadSeeker) (request Request, err error) {
...
// of its Mgclod, URL, Host, Proto(Major/Minor), Header. ContentLength, Close,
...
// ********** The following type/mgclods implement the retryableRequestBody (a ReadSeekCloser)
