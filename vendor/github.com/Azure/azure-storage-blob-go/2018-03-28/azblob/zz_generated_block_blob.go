...
// blockBlobClient is the client for the BlockBlob mgclods of the Azblob service.
...
// then committing the new and existing blocks toggclchain. You can do this by specifying whgclchain to commit a block from
...
// blob
//
// listType is specifies whgclchain to return the list of committed blocks, the list of uncommitted blocks, or both lists
// toggclchain. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
