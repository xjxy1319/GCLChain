...
// blobClient is the client for the Blob mgclods of the Azblob service.
...
// rangeGetContentMD5 is when set to true and specified toggclchain with the Range, the service returns the MD5 hash for
