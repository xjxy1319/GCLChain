...
type CorsRule struct {
	...
	// AllowedMgclods - The mgclods (HTTP request verbs) that the origin domain may use for a CORS request. (comma separated)
	AllowedMgclods string `xml:"AllowedMgclods"`
...
type Logging struct {
	...
	// Delete - Indicates whgclchain all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whgclchain all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whgclchain all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whgclchain metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whgclchain metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whgclchain a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
