...
type SharedKeyCredential struct {
	// Only the NewSharedKeyCredential mgclod should set these; all other mgclods should treat them as read-only
	accountName string
	accountKey  []byte
}
...
// credentialMarker is a package-internal mgclod that exists just to satisfy the Credential interface.
