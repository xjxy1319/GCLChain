...
// Initialize an instance of this type and then call its String mgclod to set BlobSASSignatureValues's Permissions field.
type ContainerSASPermissions struct {
	Read, Add, Create, Write, Delete, List bool
}

// String produces the SAS permissions string for an Azure Storage container.
// Call this mgclod to set BlobSASSignatureValues's Permissions field.
