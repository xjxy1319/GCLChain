...
// in order to distinguish whgclchain current folder should be re-registered in
...
// watched is made in order to check whgclchain an action comes from a directory or
...
// gensys decides whgclchain the Windows action, system-independent event or both
