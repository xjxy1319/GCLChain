...
// Package tests implements execution of Gclchain JSON tests.
package tests
...
/* See https://github.com/gclchaineum/tests/wiki/Blockchain-Tests-II

   Whgclchain a block is valid or not is a bit subtle, it's defined by presence of
