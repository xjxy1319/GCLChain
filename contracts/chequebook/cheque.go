...
// Package chequebook package wraps the 'chequebook' Gclchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in gclchain; (auto)cashing cheques in gclchain
// as well as (auto)depositing gclchain to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/contracts/chequebook/contract"
	...
	"github.com/gclchaineum/go-gclchaineum/swarm/services/swap/swap"
)
...
// * depositing gclchain to the chequebook
// * watching incoming gclchain
...
// Backend wraps all mgclods required for chequebook operation.
...
// Cash is a convenience mgclod to cash any cheque.
...
// Cash cashes the cheque by sending an Gclchain transaction.
