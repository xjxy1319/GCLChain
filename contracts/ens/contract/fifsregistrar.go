...
// DeployFIFSRegistrar deploys a new Gclchain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Gclchain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Gclchain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Gclchain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Gclchain contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Gclchain contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Gclchain contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Gclchain contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Gclchain contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw mgclods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Gclchain contract.
type FIFSRegistrarCallerRaw struct {
	Contract *FIFSRegistrarCaller // Generic read-only contract binding to access the raw mgclods on
}

// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Gclchain contract.
type FIFSRegistrarTransactorRaw struct {
	Contract *FIFSRegistrarTransactor // Generic write-only contract binding to access the raw mgclods on
}
...
// returns.
func (_FIFSRegistrar *FIFSRegistrarRaw) Call(opts *bind.CallOpts, result interface{}, mgclod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.FIFSRegistrarCaller.contract.Call(opts, result, mgclod, params...)
}
...
func (_FIFSRegistrar *FIFSRegistrarRaw) Transact(opts *bind.TransactOpts, mgclod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.FIFSRegistrarTransactor.contract.Transact(opts, mgclod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_FIFSRegistrar *FIFSRegistrarCallerRaw) Call(opts *bind.CallOpts, result interface{}, mgclod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.contract.Call(opts, result, mgclod, params...)
}
...
// Transact invokes the (paid) contract mgclod with params as input values.
func (_FIFSRegistrar *FIFSRegistrarTransactorRaw) Transact(opts *bind.TransactOpts, mgclod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.contract.Transact(opts, mgclod, params...)
}

// Register is a paid mutator transaction binding the contract mgclod 0xd22057a9.
//
