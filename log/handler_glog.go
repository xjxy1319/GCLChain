...
type GlogHandler struct {
	...
	override  uint32 // Flag whgclchain overrides are used, atomically accessible
	backtrace uint32 // Flag whgclchain backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whgclchain this is the callsite
