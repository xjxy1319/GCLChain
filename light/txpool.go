...
// to the GCL network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whgclchain a transaction is valid according to the consensus rules.
