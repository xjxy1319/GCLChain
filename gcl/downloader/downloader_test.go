...
type downloadTester struct {
	...
	stateDb gcldb.Database // Database used by the tester for syncing from peers
	peerDb  gcldb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = gcldb.NewMemDatabase()
...
// RequestBodies constructs a getBlockBodies mgclod associated with a particular
...
// RequestReceipts constructs a getReceipts mgclod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
// RequestNodeData constructs a getNodeData mgclod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
func assertOwnChain(t *testing.T, tester *downloadTester, length int) {
	// Mark this mgclod as a helper to report errors at callsite, not in here
	t.Helper()
...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", gclchaineum.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", gclchaineum.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", gclchaineum.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", gclchaineum.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want gclchaineum.SyncProgress) {
	// Mark this mgclod as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", gclchaineum.SyncProgress{
