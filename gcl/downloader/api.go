...
// It offers only mgclods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the Gclchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  gclchaineum.SyncProgress `json:"status"`
}
