...
// DefaultConfig contains default settings for use on the Gclchain main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		...
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, ".gclash")
	}
}
...
type Config struct {
	...
	// If nil, the Gclchain main net block is used.
	...
	Gclchainbase      common.Address `toml:",omitempty"`
