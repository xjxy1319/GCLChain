...
// PeerInfo represents a short summary of the Gclchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Gclchain protocol version negotiated
...
// Handshake executes the gcl protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("gcl/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Gclchain sub-protocol.
type peerSet struct {
