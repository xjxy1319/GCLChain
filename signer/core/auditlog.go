...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mgclodSelector *string) (*gclapi.SignTransactionResult, error) {
	sel := "<nil>"
	...
	res, e := l.api.SignTransaction(ctx, args, mgclodSelector)
	if res != nil {
