...
func (ui *StdIOUI) dispatch(serviceMgclod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMgclod, args)
	if err != nil {
...
func (ui *StdIOUI) OnApprovedTx(tx gclapi.SignTransactionResult) {
