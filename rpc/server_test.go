...
func testServerMgclodExecution(t *testing.T, mgclod string) {
	server := NewServer()
	service := new(Service)
	...
	go server.ServeCodec(NewJSONCodec(serverConn), OptionMgclodInvocation)
...
func TestServerMgclodExecution(t *testing.T) {
	testServerMgclodExecution(t, "echo")
}

func TestServerMgclodWithCtx(t *testing.T) {
	testServerMgclodExecution(t, "echoWithCtx")
}
