...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *gcldb.MemDatabase {
	var provers []func(key []byte) *gcldb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *gcldb.MemDatabase {
		proof := gcldb.NewMemDatabase()
