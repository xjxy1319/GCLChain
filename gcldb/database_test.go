...
func newTestLDB() (*gcldb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "gcldb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := gcldb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(gcldb.NewMemDatabase(), t)
}

func testPutGet(db gcldb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(gcldb.NewMemDatabase(), t)
}

func testParallelPutGet(db gcldb.Database, t *testing.T) {
	const n = 8
