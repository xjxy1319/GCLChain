...
// Whisper represents a dark communication interface through the Gclchain
...
// New creates a Whisper client ready to communicate through the Gclchain P2P network.
...
// param isP2P indicates whgclchain the message is peer-to-peer (should not be forwarded).
