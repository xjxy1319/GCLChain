...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whgclchain local transaction handling should be disabled
...
// manner. This mgclod is only ever used in the tester!
...
// validateTx checks whgclchain a transaction is valid according to the consensus
...
//
// Note, this mgclod assumes the pool lock is held!
...
// and returns whgclchain it was inserted or an older was better.
//
// Note, this mgclod assumes the pool lock is held!
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if somgcling was actually added
	if len(dirty) > 0 {
...
// cannot be derived, this mgclod returns false.
