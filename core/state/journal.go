...
type journalEntry interface {
	...
	// dirtied returns the Gclchain address modified by this journal entry.
...
// otherwise suggest it as clean. This mgclod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whgclchain account had already suicided
		prevbalance *big.Int
	}
