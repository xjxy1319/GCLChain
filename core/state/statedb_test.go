...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := gcldb.NewMemDatabase()
	finalDb := gcldb.NewMemDatabase()
...
// https://github.com/gclchaineum/go-gclchaineum/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(gcldb.NewMemDatabase()))
...
// accessor mgclods on the reverted state must match the return value of the equivalent
// mgclods on the replayed state.
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(gcldb.NewMemDatabase()))
...
// checkEqual checks that mgclods of state and checkstate return the same values.
...
// See https://github.com/gclchaineum/go-gclchaineum/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(gcldb.NewMemDatabase()))
