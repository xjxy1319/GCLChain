...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(gcldb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db gcldb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db gcldb.Database, root common.Hash) error {
...
func checkStateConsistency(db gcldb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, gcldb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(gcldb.Database), srcRoot)
