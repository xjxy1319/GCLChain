...
// Package types contains data types related to Gclchain consensus.
package types
...
// Header represents a block header in the Gclchain blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) toggclchain.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Gclchain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package gcl to track
...
// [deprecated by gcl/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for gcl protocol, etc.
...
// DecodeRLP decodes the Gclchain
...
// EncodeRLP serializes b into the Gclchain RLP block format.
