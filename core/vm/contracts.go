...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/crypto/bn256"
	"github.com/gclchaineum/go-gclchaineum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mgclod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Gclchain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Gclchain
...
//
// This mgclod does not require any overflow checking as the input size gas costs
