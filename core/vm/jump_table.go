...
type operation struct {
	...
	halts   bool // indicates whgclchain the operation should halt further execution
	jumps   bool // indicates whgclchain the program counter should not increment
	writes  bool // determines whgclchain this a state modifying operation
	valid   bool // indication whgclchain the retrieved operation is valid and known
	reverts bool // determines whgclchain the operation reverts state (implicitly halts)
	returns bool // determines whgclchain the operations sets the return data content
}
