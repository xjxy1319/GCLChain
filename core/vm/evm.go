...
type Context struct {
	// CanTransfer returns whgclchain the account contains
	// sufficient gclchain to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers gclchain from one account to the other
...
// EVM is the Gclchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) gclchaineum virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whgclchain the max code size has been exceeded
