...
func SetupGenesisBlock(db gcldb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}
func SetupGenesisBlockWithOverride(db gcldb.Database, genesis *Genesis, constantinopleOverride *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whgclchain the genesis block is already written.
	if genesis != nil {
...
func (g *Genesis) ToBlock(db gcldb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db gcldb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db gcldb.Database) *types.Block {
...
func GenesisBlockForTesting(db gcldb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Gclchain main net genesis block.
...
// DeveloperGenesisBlock returns the 'ggcl --dev' genesis block. Note, this must
// be seeded with the
