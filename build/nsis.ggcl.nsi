...
# 1. install ggcl for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ggcl
# 5. create ggcl, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable GCLCHAIN_SOCKET
...
!define GROUPNAME "Gclchain"
!define APPNAME "Ggcl"
!define DESCRIPTION "Official Go implementation of the Gclchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ggcl is installed global
