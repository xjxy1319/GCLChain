...
Please review the resulting diff to check whgclchain the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-gclchaineum authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-gclchaineum Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-gclchaineum"
	}
	if startOfSentence {
		return "The go-gclchaineum library"
	}
	return "the go-gclchaineum library"
}
