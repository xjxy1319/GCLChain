Name "ggcl ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/gclchaineum/go-gclchaineum/issues"
!define UPDATEURL "https://github.com/gclchaineum/go-gclchaineum/releases"
!define ABOUTURL "https://github.com/gclchaineum/go-gclchaineum#gclchaineum-go"
...
# Install ggcl binary
Section "Ggcl" GGCL_IDX
  SetOutPath $INSTDIR
  file {{.Ggcl}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ggcl.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ggcl.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ggcl incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggcl outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggcl UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ggcl incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ggcl.exe" "" "" "Gclchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ggcl outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ggcl.exe" "" "" "Gclchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ggcl UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ggcl.exe" "" "" "Gclchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/gclchaineum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "GCLCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\ggcl.ipc"
  ${EnvVarUpdate} $0 "GCLCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\ggcl.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GGCL_IDX}
    SectionGetSize ${GGCL_IDX} $0
