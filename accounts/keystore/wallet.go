...
// Status implements accounts.Wallet, returning whgclchain the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain gclchaineum.ChainStateReader) {}
