...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/gclchaineum/pygclsaletool

		pygclsaletool generates the encryption key from password by
	...
	*/
	...
	gclPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(gclPriv)
