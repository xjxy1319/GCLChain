...
// See https://github.com/gclchaineum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whgclchain the event notification loop is running
...
// HasAddress reports whgclchain a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Gclchain presale wallet and stores
