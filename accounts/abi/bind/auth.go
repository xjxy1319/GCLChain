...
// NewTransactor is a utility mgclod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility mgclod to easily create a transaction signer
