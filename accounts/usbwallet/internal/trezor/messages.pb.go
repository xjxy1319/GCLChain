...
const (
	...
	MessageType_MessageType_GclchainGetAddress       MessageType = 56
	MessageType_MessageType_GclchainAddress          MessageType = 57
	MessageType_MessageType_GclchainSignTx           MessageType = 58
	MessageType_MessageType_GclchainTxRequest        MessageType = 59
	MessageType_MessageType_GclchainTxAck            MessageType = 60
	...
	MessageType_MessageType_GclchainSignMessage      MessageType = 64
	MessageType_MessageType_GclchainVerifyMessage    MessageType = 65
	MessageType_MessageType_GclchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_GclchainGetAddress",
	57:  "MessageType_GclchainAddress",
	58:  "MessageType_GclchainSignTx",
	59:  "MessageType_GclchainTxRequest",
	60:  "MessageType_GclchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_GclchainSignMessage",
	65:  "MessageType_GclchainVerifyMessage",
	66:  "MessageType_GclchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_GclchainGetAddress":       56,
	"MessageType_GclchainAddress":          57,
	"MessageType_GclchainSignTx":           58,
	"MessageType_GclchainTxRequest":        59,
	"MessageType_GclchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_GclchainSignMessage":      64,
	"MessageType_GclchainVerifyMessage":    65,
	"MessageType_GclchainMessageSignature": 66,
...
// *
// Request: Ask device for Gclchain address corresponding to address_n path
// @next PassphraseRequest
// @next GclchainAddress
// @next Failure
type GclchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *GclchainGetAddress) Reset()                    { *m = GclchainGetAddress{} }
func (m *GclchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*GclchainGetAddress) ProtoMessage()               {}
func (*GclchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *GclchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *GclchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Gclchain address derived from device private seed
// @prev GclchainGetAddress
type GclchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *GclchainAddress) Reset()                    { *m = GclchainAddress{} }
func (m *GclchainAddress) String() string            { return proto.CompactTextString(m) }
func (*GclchainAddress) ProtoMessage()               {}
func (*GclchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *GclchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type RecoveryDevice struct {
	...
	// 7 reserved for unused recovery mgclod
...
// This mgclod doesn't support streaming, so there are hardware limits in number of inputs and outputs.
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next GclchainTxRequest
// @next Failure
type GclchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *GclchainSignTx) Reset()                    { *m = GclchainSignTx{} }
func (m *GclchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*GclchainSignTx) ProtoMessage()               {}
func (*GclchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *GclchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *GclchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *GclchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *GclchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *GclchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *GclchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *GclchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *GclchainSignTx) GetDataLength() uint32 {
...
func (m *GclchainSignTx) GetChainId() uint32 {
...
func (m *GclchainTxRequest) Reset()                    { *m = GclchainTxRequest{} }
func (m *GclchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*GclchainTxRequest) ProtoMessage()               {}
func (*GclchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *GclchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *GclchainTxRequest) GetSignatureV() uint32 {
...
func (m *GclchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *GclchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev GclchainTxRequest
// @next GclchainTxRequest
type GclchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *GclchainTxAck) Reset()                    { *m = GclchainTxAck{} }
func (m *GclchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*GclchainTxAck) ProtoMessage()               {}
func (*GclchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *GclchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next GclchainMessageSignature
// @next Failure
type GclchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *GclchainSignMessage) Reset()                    { *m = GclchainSignMessage{} }
func (m *GclchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*GclchainSignMessage) ProtoMessage()               {}
func (*GclchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *GclchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *GclchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type GclchainVerifyMessage struct {
...
func (m *GclchainVerifyMessage) Reset()                    { *m = GclchainVerifyMessage{} }
func (m *GclchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*GclchainVerifyMessage) ProtoMessage()               {}
func (*GclchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *GclchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *GclchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *GclchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev GclchainSignMessage
type GclchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *GclchainMessageSignature) Reset()                    { *m = GclchainMessageSignature{} }
func (m *GclchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*GclchainMessageSignature) ProtoMessage()               {}
func (*GclchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *GclchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *GclchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GclchainGetAddress)(nil), "GclchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*GclchainAddress)(nil), "GclchainAddress")
	...
	proto.RegisterType((*GclchainSignTx)(nil), "GclchainSignTx")
	proto.RegisterType((*GclchainTxRequest)(nil), "GclchainTxRequest")
	proto.RegisterType((*GclchainTxAck)(nil), "GclchainTxAck")
	proto.RegisterType((*GclchainSignMessage)(nil), "GclchainSignMessage")
	proto.RegisterType((*GclchainVerifyMessage)(nil), "GclchainVerifyMessage")
	proto.RegisterType((*GclchainMessageSignature)(nil), "GclchainMessageSignature")
