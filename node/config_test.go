...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ggcl.ipc", false, filepath.Join(os.TempDir(), "ggcl.ipc")},
		{"data", "ggcl.ipc", false, "data/ggcl.ipc"},
		{"data", "./ggcl.ipc", false, "./ggcl.ipc"},
		{"data", "/ggcl.ipc", false, "/ggcl.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ggcl.ipc", true, `\\.\pipe\ggcl.ipc`},
		{"data", "ggcl.ipc", true, `\\.\pipe\ggcl.ipc`},
		{"data", `\\.\pipe\ggcl.ipc`, true, `\\.\pipe\ggcl.ipc`},
	}
