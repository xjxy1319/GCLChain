...
// The app's SubscribeResults mgclod starts sending calculation results to the given
// channel. Subscriptions created through this mgclod are tied to the lifetime of the App
