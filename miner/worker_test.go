...
var (
	...
	gclashChainConfig *params.ChainConfig
...
func init() {
	...
	gclashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setGclchainbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockEthash(t *testing.T) {
	testPendingStateAndBlock(t, gclashChainConfig, gclash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, gcldb.NewMemDatabase()))
}
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, gclashChainConfig, gclash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, gcldb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	gclash := gclash.NewFaker()
	defer gclash.Close()

	w, b := newTestWorker(t, gclashChainConfig, gclash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, gclashChainConfig, gclash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, gcldb.NewMemDatabase()))
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, gclashChainConfig, gclash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, gcldb.NewMemDatabase()))
}
