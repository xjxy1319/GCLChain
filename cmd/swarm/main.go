...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/swarm"
	bzzapi "github.com/gclchaineum/go-gclchaineum/swarm/api"
	swarmmetrics "github.com/gclchaineum/go-gclchaineum/swarm/metrics"
	"github.com/gclchaineum/go-gclchaineum/swarm/storage/mock"
	mockrpc "github.com/gclchaineum/go-gclchaineum/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside ggcl.
func init() {
...
var app = utils.NewApp("", "Gclchain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-gclchaineum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//ggcl only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for ggcl and swarm
	...
	//register BZZ as node.Service in the gclchaineum node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the gclchaineum node
