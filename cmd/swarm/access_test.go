...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/crypto/ecies"
	"github.com/gclchaineum/go-gclchaineum/log"
	"github.com/gclchaineum/go-gclchaineum/swarm/api"
	swarmapi "github.com/gclchaineum/go-gclchaineum/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be somgcling here")
	}
...
// the specs at https://github.com/gclchainsphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
