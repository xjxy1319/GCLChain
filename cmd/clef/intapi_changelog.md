...
* Add `OnInputRequired(info UserInputRequest)` to internal API. This mgclod is used when Clef needs user input, e.g. passwords.
...
* Add `OnStartup` mgclod, to provide the UI with information about what API version
