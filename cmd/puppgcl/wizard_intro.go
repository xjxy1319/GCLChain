...
// makeWizard creates and returns a new puppgcl wizard.
...
// setting up a new or managing an existing Gclchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppgcl, your Gclchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Gclchain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and gclstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppgcl uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Gclchain network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppgcl", w.network)
