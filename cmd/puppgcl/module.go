...
// returned from docker inspect, parsed into a form easily usable by puppgcl.
type containerInfos struct {
	running bool              // Flag whgclchain the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whgclchain there's a container running for the service
	...
	// Infos retrieved, parse the above into somgcling meaningful
