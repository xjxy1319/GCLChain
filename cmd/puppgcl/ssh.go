...
// sshClient is a small wrapper around Go's SSH client with a few utility mgclods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication mgclods (private key and password)
	var auths []ssh.AuthMgclod
...
// capable of acting as puppgcl target.
