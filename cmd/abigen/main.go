...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Gclchain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Gclchain contract bytecode (generate deploy mgclod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Gclchain contract Solidity source to build and bind")
