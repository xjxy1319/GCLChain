...
// Package gclchaineum defines interfaces for interacting with Gclchain.
package gclchaineum
...
// NotFound is returned by API mgclods if the requested item does not exist.
...
// ChainReader provides access to the blockchain. The mgclods in this interface access raw
...
type ChainReader interface {
	...
	// This mgclod subscribes to notifications about changes of the head block of
	// the canonical chain.
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whgclchain the transaction has been
...
type CallMsg struct {
	...
	Data     []byte          // input data, usually an ABI-encoded contract mgclod invocation
}

// A ContractCaller provides contract calls, essentially transactions that are executed by
// the EVM but not mined into the blockchain. ContractCall is a low-level mgclod to
...
// TransactionSender wraps transaction sending. The SendTransaction mgclod injects a
// signed transaction into the pending transaction pool for execution. If the transaction
// was a contract creation, the TransactionReceipt mgclod can be used to retrieve the
