...
see https://github.com/gclchaineum/go-gclchaineum/issues/2040
Usage:

import (
 "github.com/gclchaineum/go-gclchaineum/common/httpclient"
 "github.com/gclchaineum/go-gclchaineum/swarm/api/http"
)
...
func (self *RoundTripper) RoundTrip(req *http.Request) (resp *http.Response, err error) {
	...
	reqProxy, err := http.NewRequest(req.Mgclod, url, req.Body)
	if err != nil {
		return nil, err
	}
