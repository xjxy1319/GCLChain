...
type Pss struct {
	...
	*KeyStore
	...
	fwdCache        map[pssDigest]pssCacheEntry // checksum of unique fields from pssmsg mapped to expiry, cache to determine whgclchain to drop msg
...
// add API mgclods to the pss API
