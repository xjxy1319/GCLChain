...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/swarm/pot"
...
// matching of address hints; whgclchain a message could be or is for the node
...
func TestAddressMatchProx(t *testing.T) {
	...
	// first the unit test on the mgclod that calculates possible receipient using prox
