...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/ggcl.ipc",
			endpoint:    "/data/testnet/ggcl.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/ggcl.ipc",
			endpoint:    "/data/testnet/ggcl.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ggcl.ipc",
			endpoint:    "/data/testnet/ggcl.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ggcl.ipc",
			endpoint:    "/data/testnet/ggcl.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
		{
			...
			value:       "gcl:314159265dD8dbb310642f98f50C066173C1259b@http://127.0.0.1:1234",
			endpoint:    "http://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "gcl",
		},
		{
			...
			value:       "gcl:314159265dD8dbb310642f98f50C066173C1259b@ws://127.0.0.1:1234",
			endpoint:    "ws://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "gcl",
		},
...
// https://github.com/gclchainsphere/go-gclchaineum/issues/639
// where pyramid chunker did not split correctly files with lengths that
// are edge cases for chunk and tree parameters, depending whgclchain there
