...
// mgclods to add new intervals and retrieve missing intervals that
// need to be added.
...
// No range bellow start bound will be added by Add mgclod or
// returned by Next mgclod. This limit may be used for
