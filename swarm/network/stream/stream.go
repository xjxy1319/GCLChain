...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/swarm/network/stream/intervals"
...
// setNextBatch adjusts passed interval based on session index and whgclchain
...
// the price for a message via the Price mgclod
