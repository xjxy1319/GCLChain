...
func (p *BzzPeer) ID() enode.ID {
	// This is here to resolve a mgclod tie: both protocols.Peer and BzzAddr are embedded
...
// RandomAddr is a utility mgclod generating an address from a public key
