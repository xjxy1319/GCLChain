...
Newly created requests are satisfied bound toggclchain in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state toggclchain with an initial offset.
