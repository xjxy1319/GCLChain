...
import (
	...
	"github.com/gclchaineum/go-gclchaineum/p2p/simulations"
...
// argument toe AddNode and other add node related mgclods.
...
// AddNodesAndConnectFull is a helpper mgclod that combines
...
// AddNodesAndConnectChain is a helpper mgclod that combines
// AddNodes and ConnectNodesChain. The chain will be continued from the last
// added node, if there is one in simulation using ConnectToLastNode mgclod.
...
// AddNodesAndConnectRing is a helpper mgclod that combines
...
// AddNodesAndConnectStar is a helpper mgclod that combines
...
// This mgclod tries to open the json file provided, applies the config to all nodes
