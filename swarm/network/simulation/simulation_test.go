...
// TestRun tests if Run mgclod calls RunFunc and if it handles context properly.
...
// TestClose tests are Close mgclod triggers all close functions and are all nodes not up anymore.
...
// TestDone checks if Close mgclod triggers the closing of done channel.
