...
// Simulation provides mgclods on network, nodes and services
// to manage them.
...
// on Simulation.Run mgclod call.
type RunFunc func(context.Context, *Simulation) error

// Result is the returned value of Simulation.Run mgclod.
type Result struct {
...
// is closed by Close mgclod. It is useful for signaling termination
