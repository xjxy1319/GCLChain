...
// GlobalStorer defines mgclods for mock db store
...
// Importer defines mgclod for importing mock store data
// from an exported tar archive.
type Importer interface {
	Import(r io.Reader) (n int, err error)
}

// Exporter defines mgclod for exporting mock store data
// to a tar archive.
