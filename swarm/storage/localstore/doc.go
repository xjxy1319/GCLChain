// Copyright 2019 The go-gclchaineum Authors
...
The main type is DB which manages the storage by providing mgclods to
...
that provides adequate mgclod to perform the opperation and that type
...
Subscription mgclods are implemented for a specific purpose of
