...
// mgclod triggerings. In the affected component's shouldComponentUpdate mgclod it can be checked
// whgclchain the involved data was changed or not by checking the message structure.
//
