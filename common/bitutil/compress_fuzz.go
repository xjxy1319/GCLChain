...
// Fuzz implements a go-fuzz fuzzer mgclod to test various encoding mgclod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mgclod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mgclod to test the bit decoding and
