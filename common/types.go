...
// Address represents the 20 byte address of an Gclchain account.
...
// IsHexAddress verifies whgclchain a string can represent a valid hex-encoded
// Gclchain address or not.
