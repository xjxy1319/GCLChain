...
// Contains a wrapper for the Gclchain client.
...
// GclchainClient provides access to the Gclchain APIs.
type GclchainClient struct {
	client *gclclient.Client
}

// NewGclchainClient connects a client to the given URL.
func NewGclchainClient(rawurl string) (client *GclchainClient, _ error) {
	rawClient, err := gclclient.Dial(rawurl)
	return &GclchainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *GclchainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *GclchainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *GclchainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *GclchainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *GclchainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *GclchainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *GclchainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *GclchainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *GclchainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *GclchainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *GclchainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *GclchainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *GclchainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *GclchainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *GclchainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *GclchainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *GclchainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *GclchainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *GclchainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *GclchainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
//
// If the transaction was a contract creation use the TransactionReceipt mgclod to get the
// contract address after the transaction has been mined.
func (ec *GclchainClient) SendTransaction(ctx *Context, tx *Transaction) error {
